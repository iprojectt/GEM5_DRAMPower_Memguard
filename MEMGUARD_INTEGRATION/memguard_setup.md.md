...
MemGuard is a Linux kernel module used to **control and enforce memory bandwidth limits** for CPU cores.  
In this setup, MemGuard is compiled and loaded inside a **Linux guest running in gem5**.
...
Then rebuild the module. I will alk about these Later.
